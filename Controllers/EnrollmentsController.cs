...
using ControlsAndScaffoldingTemplates.DAL;
using ControlsAndScaffoldingTemplates.Models;
...
namespace ControlsAndScaffoldingTemplates.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        // POST: Enrollments/Testing/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Testing([Bind(Include = "EnrollmentID,CourseID,StudentID,Grade")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
                db.Entry(enrollment).State = EntityState.Modified;
